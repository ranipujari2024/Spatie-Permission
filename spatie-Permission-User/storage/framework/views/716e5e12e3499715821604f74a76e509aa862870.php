...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" name="name" placeholder="Enter Name" id="full-name-1">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter email" required autocomplete="email">
...
unset($__errorArgs, $__bag); ?> form-select" name="role" data-placeholder="Select System User">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp_workspace\htdocs\spatie-Permission-User\resources\views/role-permission/user/create.blade.php ENDPATH**/ ?>